...
function CashOrCard() {
    return (
        ...
        <div className="lg:flex">
            ...
            <div className="md:flex">
                <div className="flex py-6 w-full">
                    <img className="w-28 " src="./images/1A.png" alt=""></img>
                    <div className="ml-4">
                ...
                <div className="flex py-6 w-full">
                    <img className="w-28 h-40" src="./images/1B.png" alt=""></img>
                    <div className="ml-4">
        ...
        <div className="lg:flex">
            ...
            <div className="md:flex">
                <div className="flex py-6 w-full">
                    <img className="w-28 h-40" src="./images/2A.png" alt=""></img>
                    <div className="ml-4">
                ...
                <div className="flex py-6 w-full">
                    <img className="w-28 h-40" src="./images/2B.png" alt=""></img>
                    <div className="ml-4">
        ...
        <div className="lg:flex">
            ...
            <div>
                <div className="flex py-6 md:w-1/2">
                    <img className="w-28 h-40" src="./images/3A.png" alt=""></img>
                    <div className="ml-4">
